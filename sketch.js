...
//left side
  ...
  moveRight = createSprite(200,535,20,20);
  moveUp = createSprite(180,510,20,20);
  moveLeft = createSprite(160,535,20,20);
  moveDown = createSprite(180,560,20,20);
  ...
  if(keyDown("D")) {
    ...
    snake2.scale = 0.3;
  } else if(moveRight.mousePressed === true) {
    snake1.velocityY = 0;
    snake2.velocityY = 0;
  ...
  if(keyDown("S")) {
    ...
    snake2.scale = 0.3;
  } else if(moveDown.mousePressed === true) {
    snake1.velocityX = 0;
    snake2.velocityX = 0;
  ...
  if(keyDown("W")) {
    ...
    snake2.scale = 0.3;
  } else if(moveUp.mousePressed === true) {
    snake1.velocityX = 0;
    snake2.velocityX = 0;
  ...
  if(keyDown("A")) {
    ...
    snake1.addImage(snakeImageRight);
    snake2.addImage(snakeImageRight);
  } else if(moveLeft.mousePressed === true) {
    snake1.velocityY = 0;
    snake2.velocityY = 0;
